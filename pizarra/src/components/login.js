...
class Login extends Component {
    constructor(props) {
        super(props)
        this.state = { usuario: '', contra: '', redirect: false, mostrarModal: false, mostrarLabel: false }
        ...
        return (
            <div>
                <VentanaModal show={this.state.mostrarModal} onHide={cerrarModal}
                    cuerpo={'Lo sentimos, no pudimos encontrar esa combinación de nombre de usuario y contraseña.'} />
                    ...
                    <div className="container-login100">
                        <div className="wrap-login100 p-t-30 p-b-50">
                            ...
                            <form className="login100-form validate-form p-b-33 p-t-5" onSubmit={this.handleSubmit}>
                                <div className={mostrar.join(' ')} data-validate="Ingresa tu nombre de usuario.">
                                    <input className="input100" type="text" name="usuario" placeholder="Nombre de usuario." value={this.state.usuario} onChange={this.onChange}></input>
                                <span className="focus-input100" data-placeholder="&#xe82a;"></span>
                                </div>
                            <div className={mostrar.join(' ')} data-validate="Ingresa tu contraseña.">
                                <input className="input100" type="password" name="contra" placeholder="Contraseña." value={this.state.contra} onChange={this.onChange}></input>
                                <span className="focus-input100" data-placeholder="&#xe80f;"></span>
                            </div>
